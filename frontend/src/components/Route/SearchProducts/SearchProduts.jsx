...
export default function SearchProducts({ allProducts }) {
  ...
  const [loading, setLoading] = useState(false);
    ...
    const fetchProducts = async () => {
      setLoading(true);
      // console.log('filter before call API',filtersAPI)
      const body = {
    ...
    useEffect(() => {
      fetchProducts(); // Gọi API khi filtersAPI thay đổi
    }, [filtersAPI,pageNumber,pageSize]); // Theo dõi filtersAPI để gọi lại API
          ...
          <div className="w-full lg:flex lg:space-x-[30px]">
            <div className="lg:w-[270px]">
              <ProductsFilter
                ...
                handleCheckboxCategoriesChange={handleCheckboxCategoriesChange}
              ...
              <div className="products-sorting w-full bg-white md:h-[70px] flex md:flex-row flex-col md:space-y-0 space-y-5 md:justify-between md:items-center p-[30px] mb-[40px]">
                <div>
                  <p className="font-400 text-[13px]">
                    <span className="text-qgray"> Showing</span> 1-{products.length} of {totalProduct} {" "} 
                    results
                  </p>
                </div>
                <div className="flex space-x-3 items-center">
                  <div className="flex space-x-3 items-center border-b border-b-qgray">
                      ...
                      <div className="flex space-x-3 items-center">
                  <span className="font-400 text-[13px]">Items per page:</span>
                  <select
                    value={pageSize}
