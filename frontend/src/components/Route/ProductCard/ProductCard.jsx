        ...
        <div className="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
          ...
          <div className="col">
            <div className="card border-0 ">
              <div className="group relative w-[258px] h-[320px] overflow-hidden border border-slate-300">
                <img
                  src={data?.images[0]?.url}
                ...
                <img
                  ...
                  className="absolute w-full h-full top-0 left-0 object-cover z-10 transition-opacity duration-300 ease-linear opacity-0 group-hover:opacity-100"
                  alt="Back"
                />
                <h4 className="relative top-[320px] text-center p-2.5 bg-[#fdfdfd] transition-all duration-200 ease-custom mx-2.5 uppercase font-medium text-sm z-30 cursor-pointer group-hover:top-[270px]">
                  Add to cart
                </h4>
              </div>
              {/* Product Information */}
